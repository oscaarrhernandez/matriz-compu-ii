...
imp_menu_principal:
	...
	.ascii "*-----------------------------------------*\n"
	.ascii "\n"
	.ascii "1) Introducir dimensiones de la matriz\n"
	.ascii "2) Leer el contenido de la matriz(Numeros de 3 cifras)\n"
	.ascii "3) Mostrar la matriz por pantalla\n"
	.ascii "4) Salir\33[37m\n"
...
menu:
	...
	jsr imprime_cadena
	lda teclado
	cmpa #1 ;introducir dimensiones
		beq intr_dimensiones
	cmpa #2 ;rellenar matriz
		beq	rellenar_matriz
	cmpa #3 ;mostrar matriz
		beq mostrar_matriz
	cmpa #4 ; salir
		beq acabar
